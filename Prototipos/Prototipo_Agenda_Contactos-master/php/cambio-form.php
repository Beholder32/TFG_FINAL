...
<div>
    ...
    <input type="date" id="nacimiento" class="cambio" name="nacimiento_txt" placeholder="Escribe tu cumpleaños" title="Fecha nacimiento" value="<?php echo $registro_contacto["nacimiento"]; ?>" required />
</div>
<div>
